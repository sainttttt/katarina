...
void meow2(DSPRef pDSP, const char *sound, float **arr, int frameLength);
...
public:
    ...
    virtual void meow3(const char *sound, float **arr, int frameLength) {
      printf("baa meow3 init\n");
    };

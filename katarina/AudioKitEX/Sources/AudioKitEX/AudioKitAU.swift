...
open class AudioKitAU: AUAudioUnit {
    ...
    public func load(sound: String, floats: UnsafeMutablePointer<UnsafeMutablePointer<Float>?>, frameLength: Int) {
        ...
        //    //cArray.baseAddress
        //    meow2(dsp, sound, cArray.baseAddress)
        //}

///cArray.dealloc(array.count)

        // .withUnsafePointerToElements in Swift 2.x
        // array.withUnsafeMutableBufferPointer() { (cArray: UnsafeMutableBufferPointer<Float>) -> () in
        //     // do something with the C array
        //     meow2(dsp, sound, cArray)
        // }
    }
